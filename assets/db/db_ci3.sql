...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Feb 2023 pada 06.35
...
CREATE TABLE `absensi` (
  ...
  `tanggal_validasi_dosen` datetime DEFAULT NULL
...
INSERT INTO `absensi` (`id_absen`, `kode_matkul`, `kode_dosen`, `npm`, `latitude`, `longitude`, `status`, `tanggal_absen`, `tanggal_validasi_dosen`) VALUES
(9, 'GE12', 'HG01', '440A58869431', '-6.265551', '106.999237', 'Hadir', '2023-02-04 00:00:00', NULL),
(10, 'GE13', 'HG01', '440A58869431', '-6.265551', '106.999237', 'Hadir', '2023-02-03 00:00:00', NULL),
(11, 'AT11', 'WS09', '440A58869431', '-6.265551', '106.999237', 'Hadir', '2023-02-05 00:00:00', NULL),
(12, 'GE12', 'HG01', NULL, NULL, NULL, NULL, NULL, NULL),
(13, 'GE13', 'HG01', NULL, NULL, NULL, NULL, NULL, NULL),
(14, 'AT11', 'WS09', NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `dokumen` (
  ...
  `nama_doc` varchar(128) NOT NULL,
  `title_doc` varchar(128) NOT NULL,
  `kode_doc` varchar(128) NOT NULL,
  `kode_matkul` varchar(128) NOT NULL,
  `kode_dosen` varchar(128) NOT NULL,
  `npm` varchar(128) NOT NULL,
  `komentar_doc` varchar(255) DEFAULT NULL,
  `tipe_doc` int(11) NOT NULL,
...
INSERT INTO `dokumen` (`id_doc`, `nama_doc`, `title_doc`, `kode_doc`, `kode_matkul`, `kode_dosen`, `npm`, `komentar_doc`, `tipe_doc`, `size`, `berkas`, `date_created`) VALUES
(15, 'PDF Bahasa Jerman', 'Belajar Bahasa Jerman', 'GE11', 'GE12', 'HG01', '', 'File untuk belajar bahasa Jerman', 1, 2318, 'Mudah_dan_Praktis_Belajar_Bahasa_Jerman_(_PDFDrive_).pdf', '2023-01-08');
...
(22, 6, 'Info Website', 'user/info', 'fas fa-fw fa-info-circle', 1),
(24, 3, 'Dokumen Ajar', 'dosen/dokumen', 'fas fa-fw fa-folder', 1),
(25, 4, 'Materi dan Tugas', 'mahasiswa/dokumen', 'fas fa-fw fa-folder', 1),
(26, 4, 'Absensi', 'mahasiswa/absensi', 'fas fa-fw fa-check-square', 1);
...
(3, 'Admin', 'admin@gmail.com', 'image_processing20210911-11876-uh1f5n.gif', '$2y$10$uoaCsvHUDrKSh6ufTmdWV.ZEn/CbdYQNkSZ.sZj4EgEMXRbW668iq', 1, 1, 1671186578, ''),
...
(26, 'Elysia Zauberg', 'elysia@gmail.com', 'そは絵_on_Twitter.png', '$2y$10$IbpC8n5j4DsQWjvH1IKFI.3hbTP3DEXCFoEqcOEOsPxEembLDEIPG', 4, 1, 1671369323, '440A58869431'),
...
--
-- Struktur dari tabel `waktu_shift`
--

CREATE TABLE `waktu_shift` (
  `id_shift` bigint(20) NOT NULL,
  `kode_shift` varchar(25) DEFAULT NULL,
  `shift_awal` varchar(25) DEFAULT NULL,
  `shift_akhir` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `waktu_shift`
--

INSERT INTO `waktu_shift` (`id_shift`, `kode_shift`, `shift_awal`, `shift_akhir`) VALUES
(1, 'P', '08:00:00', '12:00:00'),
(2, 'M', '19:00:00', '23:00:00');
...
--
-- Indeks untuk tabel `waktu_shift`
--
ALTER TABLE `waktu_shift`
...
--
ALTER TABLE `dokumen`
  MODIFY `id_doc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `menu_akses`
  MODIFY `id_akses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
-- AUTO_INCREMENT untuk tabel `waktu_shift`
--
ALTER TABLE `waktu_shift`
  MODIFY `id_shift` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
